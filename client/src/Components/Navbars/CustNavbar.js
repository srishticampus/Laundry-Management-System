...
function CustNavbar() {
  ...
  const fetchData = async () => {
    try {
        const result = await ViewById('viewCustomer',localStorage.getItem('customer'));
...
const handleLogin = async (e) => {
    ...
    try {
        const result = await resetPassword(data, 'editCustomer',localStorage.getItem('customer'));
        ...
        <div className="container-fluid d-flex justify-content-between align-items-center">
          ...
          <div className="collapse navbar-collapse justify-content-center">
            <ul className="navbar-nav">
              ...
              <li className="nav-item mx-3">
                <Link to="/contact-us" className="nav-link">Feedback</Link>
              </li>
              <li className="nav-item mx-3">
                <Link to="/contact-us" className="nav-link">Enquiries</Link>
              </li>
            </ul>
          </div>
    ...
    <div className="modal-dialog" style={{ marginTop: "1px" ,maxWidth: "400px", width: "100%", marginTop: "10px"}}>
      <div className="modal-content">
        <div className="modal-header d-flex justify-content-between align-items-center">
          ...
          <img 
 src={selectedImage || `${IMG_BASE_URL}/${data.image.filename}`}            className="img-fluid cust-pro-image-rounded" 
        ...
        <div className="modal-body text-center">
          ...
          <button
    className="shop-signup-button"   onClick={openEditModal}>Edit</button>
        </div>
...
>
  <div className="position-relative">
    {/* Profile Picture */}
    <img 
       src={selectedImage || `${IMG_BASE_URL}/${data.image.filename}`}      className="cust-pro-image-rounded" 
      alt="User" 
    />
    {/* Hidden File Input */}
    <input 
