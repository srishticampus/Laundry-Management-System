    ...
    <div>
      <nav className="navbar navbar-expand-lg bg-light">
        <div className="container-fluid d-flex justify-content-between align-items-center">
          {/* Logo on the Left */}
          <Link to="/agent-home" className="navbar-brand">
          ...
          <div className="collapse navbar-collapse justify-content-center">
            <ul className="navbar-nav">
              ...
              <li className="nav-item mx-3">
                <Link to="/view-feedback-agent" className="nav-link">
                  Customer Feedback
                </Link>
              </li>
              ...
              <div className="nav-item dropdown pt-2 me-3">
                ...
                >
                  <li>
                    <Link className="dropdown-item" to={`/agent-order-reqs`}>
                      Pick Up Request
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link className="dropdown-item" to={`/agent-drop-orders`}>
                      Delivery Request
                    </Link>
                  </li>
                  <li>
