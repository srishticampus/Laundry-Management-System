                ...
                <form onSubmit={handleLogin}>
                    <div className='row mt-5'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" placeholder='Enter Shop Name' className='form-control p-2' name='name' onChange={handleChange}></input>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" placeholder='Enter Register Number' className='form-control p-2' name='regNo' onChange={handleChange}></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" placeholder='Enter Owner Name' className='form-control p-2' name='owner' onChange={handleChange}></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" placeholder='Enter Contact Number' className='form-control p-2' name='contact' onChange={handleChange}></input>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" placeholder='Add Location' className='form-control p-2' name='location' onChange={handleChange}></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" placeholder='Enter E-mail ID' className='form-control p-2' name='email' onChange={handleChange}></input>
