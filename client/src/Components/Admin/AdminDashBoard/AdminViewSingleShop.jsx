        ...
        <div className='container'>
            ...
            <div className='shop-add-staff-mainDiv'>
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <img src={`${IMG_BASE_URL}/${data.image.filename}`} className="img-fluid image-rounded " alt="User" />
                    ...
                    <div className='row mt-5'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" readOnly value={data.name} className='form-control p-2' name='name' onChange={handleChange}></input>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" value={data.regNo} readOnly className='form-control p-2' name='regNo' onChange={handleChange}></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" readOnly value={data.owner} className='form-control p-2' name='owner' onChange={handleChange}></input>

                            {errors.owner && <div id="nameError" className="invalid-feedback">{errors.owner}</div>}
                        </div>
                        <div className='col-md-5 p-2 '>
                            <label className='add-shop-label'>District</label>
                            <input type="text" readOnly value={data.district} className='form-control p-2' name='owner' onChange={handleChange}></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" readOnly value={data.contact} className='form-control p-2' name='contact' onChange={handleChange}></input>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" readOnly value={data.location}placeholder='Add Location' className='form-control p-2' name='location' onChange={handleChange}></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" readOnly value={data.email} className='form-control p-2' name='email' onChange={handleChange}></input>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" readOnly value={data.pincode} className='form-control p-2' name='pincode' onChange={handleChange}></input>
