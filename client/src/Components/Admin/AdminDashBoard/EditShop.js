...
const {id}=useParams()
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const result = await updateWithFile(data, 'editShop',id);
    ...
    return (
        <div className='container'>
            ...
            <h2 className='shop-add-staff-mainText mt-5'>  Edit Laundry Shop</h2>
                ...
                <form onSubmit={handleLogin}>
                    <div className='row mt-5'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" value={data.name} className='form-control p-2' name='name' onChange={handleChange}></input>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" value={data.regNo} className='form-control p-2' name='regNo' onChange={handleChange}></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" value={data.owner} className='form-control p-2' name='owner' onChange={handleChange}></input>

                            {errors.owner && <div id="nameError" className="invalid-feedback">{errors.owner}</div>}
                        </div>
                        <div className='col-md-5 p-2 '>
                            <label className='add-shop-label'>District</label>

                            <select placeholder='District' className='form-control p-2' value={data.district} name='district' onChange={handleChange}>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" value={data.contact} className='form-control p-2' name='contact' onChange={handleChange}></input>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" value={data.location}placeholder='Add Location' className='form-control p-2' name='location' onChange={handleChange}></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" value={data.email} className='form-control p-2' name='email' onChange={handleChange}></input>
                        ...
                        <div className='col-md-5 p-2 '>
                            ...
                            <input type="text" value={data.pincode} className='form-control p-2' name='pincode' onChange={handleChange}></input>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5 p-2'>
                            ...
                            <input type="file" className='form-control p-2' name='image' onChange={handleImageChange}></input>
                            {errors.image && <div id="nameError" className="invalid-feedback">{errors.image}</div>}
                        </div>
                        ...
                        <div className='col-md-5 p-2'>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                />
                                <div className="shop-signup-password-toggle-icon" onClick={togglePasswordVisibility}>
