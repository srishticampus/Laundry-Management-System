...
function AdminViewAllUsers() {
        ...
        const fetchData = async () => {
            try {
                const result = await viewCount('viewAllCustomer');
    ...
    Navigate(`/admin-edit-shop/${id}`)
      ...
      <h3 className=' shop-view-main-head mt-5'>View Registered Users</h3>
                <h5 className=' shop-view-head mt-3'>Registered Users</h5>
