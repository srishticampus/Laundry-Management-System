...
const UpdateService=async(id)=>{
    try {
        ...
        const result = await resetPassword({serviceStatus:'Requested Pickup'}, 'UpdateServiceStatus',id);
...
const UpdateServiceforDrop=async(id)=>{
    try {
        ...
        const result = await resetPassword({serviceStatus:'Requested Drop'}, 'UpdateServiceStatus',id);
...
const UpdateServiceforCompletion=async(id)=>{
    try {
        ...
        const result = await resetPassword({serviceStatus:'Process Completed'}, 'UpdateServiceStatus',id);
