...
<table className='details-tab'>
    ...
    <tr>
        ...
        <td>{order.district}</td>
            ...
            <div className='col-md-5'>
            <h3 className='view-more-h3'>Service Details</h3>
{services.map(item=>{
    return(
        <>
        <table className='details-tab'>
        ...
        <td colSpan="3">
            <ul>
                {item.materials.map((material, index) => (
                    <li key={index}>
                        {material.material || "N/A"} - {material.count || "0"}
                    </li>
                ))}
            </ul>
        </td>
...
export default ShopOrderViewMore