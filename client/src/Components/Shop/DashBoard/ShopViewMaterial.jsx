...
function ShopViewMaterial() {
    ...
    <span className="shop-service-div" onClick={handleViewServicesClick}>Materials</span>
            <span className="shop-service-div" onClick={handleAddServiceClick}>Add Material</span>
            {isAddingService ? (
                <>
...
<hr className='shop-add-service-hr'/>
    ...
    <form onSubmit={handleLogin}>
        <div className='row '>
            ...
            <div className='col-md-12 p-2 '>
                ...
                <input type="text" placeholder='Enter Material Name' className='form-control p-2' name='name' onChange={handleChange}></input>
    ...
    (<>
        ...
        <center>  <h3>No Materials Found</h3></center>
    </>)
}
                    </>
            )
