...
<div className='col-md-12 p-2 '>
    ...
    <textarea placeholder='Enter Description' className='form-control p-2' value={data.description} name='description' rows='3' cols='10' onChange={handleChange}></textarea>
