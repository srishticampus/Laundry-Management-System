        ...
        <div className="content-wrapper">
          ...
          <div className="order-service-container mt-5">
            ...
            <div className="row order-input-container2">
              ...
              <div className="col-md-6">
                <label className="cust-login-label mb-3">Street</label>
                <input
                  type="text"
                  className="form-control order-align-text p-2"
                  onChange={handleChange}
            ...
            <div className="row order-input-container2">
              <div className="col-md-6">
                <label className="cust-login-label mb-3">District</label>
                <select
              ...
              <div className="col-lg-6">
                <label className="cust-login-label mb-3">City</label>
                <select
            ...
            <div className="row order-input-container2">
              <div className="col-md-6">
                <label className="cust-login-label mb-3">Landmark</label>
                <input
                  type="text"
                  className="form-control"
                  name="landmark"
              ...
              <div className="col-md-6">
                <label className="cust-login-label mb-3">Pincode</label>
                <input
                  type="text"
                  className="form-control  p-2"
                  onChange={handleChange}
            ...
            <center>
              <button className="shop-signup-button mt-3" onClick={handleSave}>
                Next
              </button>
            </center>
          </div>
