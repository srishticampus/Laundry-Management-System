...
function CustEnquiries() {
  ...
  const cities = {
    ...
    Kollam: ["Kollam", "Paravur", "Punalur", "Chathannoor", "Sasthamkotta"],
    Pathanamthitta: [
      "Pathanamthitta",
      "Adoor",
      "Thiruvalla",
    ...
    Kottayam: ["Kottayam", "Changanassery", "Pala", "Ettumanoor", "Kumarakom"],
    Idukki: ["Thodupuzha", "Munnar", "Kattappana", "Adimali", "Kumily"],
    Ernakulam: [
      "Kochi",
      "Aluva",
      "Perumbavoor",
    ...
    Palakkad: ["Palakkad", "Chittur", "Ottapalam", "Mannarkkad", "Shoranur"],
    Malappuram: [
      "Malappuram",
      "Manjeri",
      "Perinthalmanna",
    ...
    Kozhikode: ["Kozhikode", "Vadakara", "Koyilandy", "Feroke", "Beypore"],
    Wayanad: [
      "Kalpetta",
      "Mananthavady",
      "Sulthan Bathery",
    ...
    Kannur: ["Kannur", "Thalassery", "Payyannur", "Taliparamba", "Mattanur"],
    Kasaragod: ["Kasaragod", "Kanhangad", "Nileshwar", "Manjeshwar", "Uppala"],
  };
              ...
              <div className="row track-row">
                ...
                <div className="col-md-3 track-col">
                  <div className="trackdelivery-container">
                    ...
                    <p>
                      We are unable to process your request due to the reasons
                    </p>

                    <p>
                      <b>Type Of Issue</b> : {item.issueType}
                    </p>
                    <p>
                ...
                {feedback.option === "reschedule" && (
                  <div className="form-group mt-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFeedback({ ...feedback, pickupDate: e.target.value })
                      }
                    />
                  </div>
                )}
                  ...
                  <div className="mt-3">
                    ...
                    <div className="form-group mt-2">
                      <input
                        ...
                        onChange={(e) =>
                          setFeedback({ ...feedback, street: e.target.value })
                        }
                      />
                    </div>
                    <div className="form-group mt-2">
                      <select
                        ...
                        onChange={(e) =>
                          setFeedback({ ...feedback, district: e.target.value })
                        }
                      >
                    ...
                    <div className="form-group mt-2">
                      <select
                        ...
                        placeholder=""
                        onChange={(e) =>
                          setFeedback({ ...feedback, city: e.target.value })
                        }
                      >
                    ...
                    <div className="form-group mt-2">
                      <input
                        ...
                        onChange={(e) =>
                          setFeedback({ ...feedback, pincode: e.target.value })
                        }
                      />
                    </div>
                    <div className="form-group mt-2">
                      <input
                        ...
                        onChange={(e) =>
                          setFeedback({ ...feedback, landmark: e.target.value })
                        }
                      />
                    </div>
                  </div>
