    ...
    <div>
      <div>
        <div className="uh-top-compo-img">
          <div className="uh-div1">
            <p className="uh-text1">
              Welcome To <span className="uh-text2">Laundry Lynx</span>
            </p>
            <p className="uh-text3">
              {" "}
              Fresh Clothes, Zero Hassle – Laundry Made Effortless!
            </p>
            <p className="uh-text4">
            ...
            <div className="uh-cards">
              ...
              <div class="card-body">
                <h5 class="card-title mb-3">
                  <center>Wet Washing</center>
                </h5>
                <p class="card-text uh-card-text">
                  Our wet washing service is ideal for everyday clothes that
                  need a deep clean. We use gentle, eco-friendly detergents to
        ...
        <div className="col-3">
          <div class="container">
            <div className="uh-cards">
              ...
              <div class="card-body">
                <h5 class="card-title mb-3">
                  <center>Dry cleaning</center>
                </h5>
                <p class="card-text uh-card-text">
                  Our professional dry cleaning service removes tough stains and
                  refreshes delicate garments without water, preserving the
                  fabric’s quality.
                </p>
              </div>
            </div>
        ...
        <div className="col-3 ">
          <div class="container">
            <div className="uh-cards">
              ...
              <div class="card-body">
                <h5 class="card-title mb-3">
                  <center>Ironing</center>
                </h5>
                <p class="card-text uh-card-text">
                  Look sharp without the hassle! Our ironing service ensures
                  your clothes are smooth, wrinkle-free, and ready to wear,
        ...
        <div className="col-3">
          <div class="container">
            <div className="uh-cards">
              ...
              <div class="card-body">
                <h5 class="card-title mb-3">
                  <center>Folding</center>
                </h5>
                <p class="card-text uh-card-text">
                  After washing, we fold your clothes neatly so they’re ready to
                  put away. Perfectly folded clothes keep your wardrobe
      ...
      <div className="row mt-5 ms-2 mb-5">
        ...
        <div className="col-6 mt-5 mb-5">
          <h2 className="uh-mission mt-5">
            Making Laundry Simple, So You Can Focus on Life.
          </h2>
          <p className="uh-mission-p">
            Laundrylynx is a one-of-a-kind laundry aggregator app aimed at
            connecting customers & laundry partners, serving an entire spectrum
            of laundry needs ranging from choosing the right laundry expert to
            price points using search & discovery, We are currently serving
            Kerala only and will soon be pan India.
          </p>
        </div>
      </div>
      <div>
