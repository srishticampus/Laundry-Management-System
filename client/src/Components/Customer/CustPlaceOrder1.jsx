    ...
    const addMore = async () => {
        ...
        try {
            if (localStorage.getItem('order')) {
                const result = await resetPassword(data, 'editOrderById', localStorage.getItem('order'));
                ...
                <div className="content-wrapper">
                    ...
                    <div className="order-service-container mt-5">
                        ...
                        <div className="row order-input-container">
                            ...
                            <div className="col-lg-3">
                                ...
                                <select
                                    ...
                                    name="material"
                                    onChange={(e) =>
                                        handleMaterialChange(0, e.target.value)
                                    }
                                >
                        ...
                        {rows.slice(1).map((row, index) => (
                            <div className="cust-order-dynamic-container">  <div
                                className="row order-input-container mt-3"
                                key={index + 1}
                            >
                                <div className="col-lg-3">
                                    <label className="cust-login-label mb-3">
                        ...
                        <center>
                            <button className="cust-orderbtn" onClick={addMore}>Add More</button>
                        </center>
                    </div>
                    <center>
