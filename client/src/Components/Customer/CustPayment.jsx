        ...
        <div className="content-wrapper">
          ...
          <div className="order-service-container mt-5">
            ...
            <div className="row order-input-container2">
              ...
              <div className="col-md-6">
                <label className="cust-login-label mb-3">Expiry Date</label>
                <input
                  type="date"
                  className="form-control order-align-text p-2"
                  onChange={handleChange}
            ...
            <div className="row order-input-container2">
              <div className="col-md-6">
                <label className="cust-login-label mb-3">CVV Number</label>
                <input
                  type="number"
                  className="form-control order-align-text p-2"
                  onChange={handleChange}
              ...
              <div className="d-flex align-items-center">
                ...
                <span className="ms-2 mt-2">
                  Save payment information to my account for future bookings
                </span>
              </div>
            </div>
          </div>
