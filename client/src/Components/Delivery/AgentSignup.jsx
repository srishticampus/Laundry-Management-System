...
function AgentSignup() {
  ...
  const handleRadioChange = (e) => {
    ...
    if (value === "No") {
      setErrors({
        ...errors,
        ownVehicle: "You cannot register without a two-wheeler.",
      });
    } else {
              ...
              <div className="cust-login-div2">
                <form>
                  <div className="image-upload flex-column d-flex align-items-center">
                    ...
                    <h6 className="text-muted mt-2">+ Add Image</h6>
                    <input
                      id="file-input"
                      type="file"
                      accept="image/*"
                  ...
                  {errors.image && (
                    <span className="text-danger left-align-error ">
                      {errors.image}
                    </span>
                  )}{" "}
                      ...
                      {ownVehicle === "Yes" && (
                        <div className="row mt-3">
                          ...
                          <div className="col-lg-6 ">
                            ...
                            />
                            {errors.rc && (
                              <span className="text-danger">{errors.rc}</span>
                            )}
                          </div>
                          <div className="col-lg-6 ">
                            <label className="cust-login-label">
                ...
                <p className="cust-signup-link mt-3">
                  ...
                  <span className="cust-login-link">
