...
const registerCustomer = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: "Customer Registered Successfully", data: newCustomer });
  } catch (error) {
    console.error(error);
...
const viewCustomers = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: "Customers retrieved successfully", data: Customers });
  } catch (error) {
...
const viewCustomerById = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: "Customer retrieved successfully", data: CustomerData });
  } catch (error) {
...
const editCustomerById = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ msg: "Customer updated successfully", data: updatedCustomer });
  } catch (error) {
...
const deleteCustomerById = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: "Customer deleted successfully", data: deletedCustomer });
  } catch (error) {
